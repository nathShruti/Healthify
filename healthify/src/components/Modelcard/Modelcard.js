    ...
    return (
            <Card className='model-card'>
                <CardContent>
                    ...
                    <TextField fullWidth id="model-symptoms" color='success' placeholder='e.g. What are the symptoms of stroke?' variant="outlined" sx={{marginTop: '3%', backgroundColor: 'white', borderRadius: '6px'}} />
                </CardContent>
                <CardActions>
